"""
RETECS METHOD
* This script was adapted from Helge Spieker's agents.py code 
* Accessed in 2022
* Available at: https://bitbucket.org/HelgeS/retecs/src/master/agents.py
...
class TableauAgent(BaseAgent):
    ...
    def reward(self, rewards):
        ...
        for ((state, act_idx), reward) in zip(self.action_history, rewards):
            ...
            new_q = prev_q + 1.0 / n * (reward - prev_q)
            self.states[state]['Q'][act_idx] = new_q
